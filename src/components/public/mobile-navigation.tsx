    ...
    open && typeof document !== 'undefined'
      ? createPortal(
          <div
            ...
            aria-modal="true"
            aria-label="網站選單"
            className="fixed inset-0 z-[100] bg-paper p-5"
          >
            <div className="mx-auto grid h-full min-h-0 max-w-lg grid-rows-[auto_minmax(0,1fr)_auto]">
              ...
              <nav
                aria-label="手機版主導覽"
                className="min-h-0 overflow-y-auto overscroll-contain py-4"
              >
